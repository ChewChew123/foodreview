                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="mainNavigation">
                        <ul class="navbar-nav ms-auto nav-pills">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="Food Guides.html">
                        ...
                        <div class="col-lg-4">
                            <div class="footer-brand">
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    <img src="image/logo.png" height="32" alt="Street Food MY" class="footer-logo">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <ul class="footer-links">
                                        <li><a href="Food Guides.html">Food Guides</a></li>
